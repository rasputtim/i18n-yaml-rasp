...
describe('Module API', function() {
  ...
  describe('Global Scope', function() {
    ...
    describe('i18nObjSetLocale and i18nObjGetLocale', ()=> {

      it('getLocale should return default setting', ()=> {
        
        i18nObj.getLocale().should.equal('en');
      });

      it('setLocale should return the new setting', ()=> {
        i18nObj.setLocale('de').should.equal('de');
      });

      it('getLocale should return the new setting', function() {
        i18nObj.setLocale('de');
        i18nObj.getLocale().should.equal('de');
      });

      it('setLocale should return a fallback value', function() {
        i18nObj.setLocale('en');
        var returnvalue = i18nObj.setLocale('nl');
        console.log(returnvalue);
        should.equal(returnvalue , 'de', 'not equal');
      });

    });

    describe('i18nObjGetCatalog', function() {
      it('should return all catalogs when invoked with empty parameters', function() {
        var catalogs = i18nObj.getCatalog();
    ...
    describe('i18nObjTranslate', function() {
      ...
      it('should be possible to use an json object as 1st parameter to specifiy a certain locale for that lookup', function() {
        ...
        i18nObj.setLocale('nl');
        should.equal(__('Hello'), 'Hallo');
      });

    });

    describe('i18nObjTranslatePlural', function() {
