...
export class LocaleService {
  ...
  constructor(myOptions) {
    ...
    this.api = {
      ...
      this.defaultLocale = ( typeof this.i18nOptions !== 'undefined' && typeof this.i18nOptions.defaultLocale === 'string') ? this.i18nOptions.defaultLocale : 'en';
      //change rasputtim
      ...
      if ( typeof this.i18nOptions !== 'undefined') 
